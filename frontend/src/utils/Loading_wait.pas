...
uses System.SysUtils, System.UITypes, FMX.Types, FMX.Controls, FMX.StdCtrls,
     ...
     FMX.VirtualKeyboard, FMX.Platform,system.Classes,Fmx.Dialogs;
type
  TLoadingWait = class
    private
...
class procedure TLoadingWait.ChangeText(const Text: string);
begin
  Mensagem.Text:=Text;
end;

class procedure TLoadingWait.Hide;
begin
...
class procedure TLoadingWait.OnClickFundo(sender: TObject);
begin
  Hide;
end;
//------------------------------------------------------------------------------
class procedure TLoadingWait.Show(const Frm : Tform; const msg,img: string;ClickAble:boolean=true);
var
