...
begin
  ...
  LabelTitulo.Margins.Left := 20;{20}
  LabelTitulo.Margins.Right := 20; {20}
...
procedure TFancyDialog.BtnMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TFancyDialog.Show(icon: TIconDialog; titulo, mensagem: string;
  TextoBtn1: string = 'OK'; CallBackBtn1: TCallbackProc = nil;
  TextoBtn2: string = ''; CallBackBtn2: TCallbackProc = nil);
var
